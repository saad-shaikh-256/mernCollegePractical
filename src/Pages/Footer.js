      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-4 d-flex flex-column align-items-center mb-4">
            <h5 className="fs-6">Quick Links</h5>
            <div className="d-flex flex-column">
              <Link to="/form" className="text-white mb-2 fs-6 text-decoration-none">Form</Link>
              <Link to="/formValidation" className="text-white mb-2 fs-6 text-decoration-none">Form Validation</Link>
              <Link to="/localStorage" className="text-white mb-2 fs-6 text-decoration-none">Local Storage</Link>
              <Link to="/showLocalData" className="text-white mb-2 fs-6 text-decoration-none">Show Local Data</Link>
            </div>
          </div>
          ...
          <div className="col-md-4 d-flex flex-column align-items-center mb-4">
            <h5 className="fs-6">Quick Links</h5>
            <div className="d-flex flex-column">
              <Link to="/userContext" className="text-white mb-2 fs-6 text-decoration-none">User Context</Link>
              <Link to="/table" className="text-white mb-2 fs-6 text-decoration-none">Table</Link>
              <Link to="/counter" className="text-white mb-2 fs-6 text-decoration-none">Counter</Link>
              <Link to="/calculator" className="text-white mb-2 fs-6 text-decoration-none">Calculator</Link>
            </div>
